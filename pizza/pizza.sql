...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : jeu. 19 mai 2022 à 08:47
...
INSERT INTO `ingredients` (`id`, `type`, `label`, `nbCalories`, `prix`) VALUES
(1, 'pate', 'pate fine', 100, 3),
...
(27, 'garniture', 'miel', 100, 3),
(28, 'garniture', 'capres', 20, 2),
(29, 'garniture', 'fourme d\'ambert', 90, 3);
...
INSERT INTO `panier` (`id`, `date`) VALUES
(1, '2022-05-12T12:33:39.6661632'),
(2, '2022-05-12T12:34:29.4816416'),
(3, '2022-05-12T12:35:55.2679305'),
(4, '2022-05-12T14:10:42.1090185'),
(5, '2022-05-18T09:28:59.3718844');
...
INSERT INTO `panier_pizza` (`panierid`, `pizzaid`) VALUES
(2, 2),
(4, 4),
(4, 0),
(4, 0),
...
(2, 'Orel', '$2a$10$lb.KVV.KGJ7s58xubcLjI.UZ71hc2h7iY5TFqZtKIMWLFApEffMIe', 'ROLE_ADMIN');
COMMIT;
